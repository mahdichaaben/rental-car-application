...
<div class="">
    ...
    <h1 class="font-serif text-3xl font-bold underline decoration-gray-400">Our cars</h1>
                <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">List of Cars</h3>
                <div class="flex items-center">

                <form action="<%= request.getContextPath() %>/home" method="GET">
                    <input type="text" name="keyword" placeholder="Search" class="border border-gray-300 px-3 py-1 rounded-lg" value="${param.keyword}">
                    <button type="submit" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-3 py-1 rounded-lg ml-2">Search</button>
                </form>
                </div>
            </div>
        <hr class="mb-4">
                            ...
                            <c:forEach var="car" items="${cars}">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
											<a href="<%= request.getContextPath() %>/rental-form?registrationNumber=${car.registrationNumber}" class="text-indigo-600 hover:text-indigo-900">Add Rental</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
