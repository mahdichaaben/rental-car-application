...
<div class="">
    ...
    <!-- Add the navigation elements here -->

    <div class="container mx-auto px-4">
    <h1 class="font-serif text-3xl font-bold underline decoration-gray-400">Manage cars</h1>
                <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold">List of Cars</h3>
                <div class="flex items-center">
                   <a href="<%= request.getContextPath() %>/car-form" class="flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-gray whitespace-no-wrap bg-white border-2 border-transparent rounded-full shadow-sm hover:bg-transparent hover:text-black hover:border-white focus:outline-none">
					Add
					</a>
                            ...
                            <c:forEach var="car" items="${cars}">
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <c:out value="${car.registrationNumber}" />
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="editcar?registrationNumber=<c:out value='${car.registrationNumber}' />" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                        <span class="px-2">|</span>
                                        <a href="deletecar?registrationNumber=<c:out value='${car.registrationNumber}' />" class="text-red-600 hover:text-red-900">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
